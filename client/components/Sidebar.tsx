  ...
  return (
    <div id='sidebar'>
      <div id='main-sidebar'>
        ...
        {/* AwsModal prop drilled and rendered in sidebar  */}
        <AwsModal
        ...
        {/* InfoModal prop drilled and rendered in sidebar  */}
        <InfoModal
